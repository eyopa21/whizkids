    ...
    <div>
        <form @submit.prevent="submit()">
            ...
            <div class="  pt-6 mt-8 rounded-b border-t border-gray-200">
                ...
                <VueButton type="submit" name="Register" variation="normal"
...
const submit = handleSubmit((formValues) => {
    ...
    if (props.employee) {
        ...
        Update({ id: props.employee.id, user_name: formValues.user_name, full_name: formValues.full_name, email: formValues.email, sex: formValues.sex, date_of_entry: formValues.date_of_entry, role: formValues.role, salary: formValues.salary })
        onUpdateDone(res => {
            console.log("done")
