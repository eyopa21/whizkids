      ...
      <div class="py-3 px-3 lg:px-5 lg:pl-3">
        <div class="flex justify-between items-center">
          <div class="flex justify-start items-center">
            ...
            <button @click="layout.showSideBar = !layout.showSideBar"
              class="block p-2 mr-2 text-gray-600 dark:text-gray-100 rounded cursor-pointer lg:hidden hover:text-gray-900 dark:hover:text-gray-300 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100">

              <div v-if="layout.showSideBar === false">
                <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path fill-rule="evenodd"
                    d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h6a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z"
                    clip-rule="evenodd"></path>
